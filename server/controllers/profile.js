...
// Singleton resource (only one Profile document): intentionally NOT built on
// createCrudController (which assumes get-by-id CRUD). Routes delegate here
// the same way skills/experiences/education/certifications/projects do.
